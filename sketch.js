...
function setup() {
    ...
    mapquare=createSprite(175,200,20,20)
    mapquare.color="green";
    mapquare2=createSprite(175,150,20,20)
    fquare=createSprite(125,175,20,20)
...
function draw() {
    ...
    if(frameCount<200) {
        ...
        text("(Don't click on the finalsquare until you finished the dungeons. Otherwise this game is prone to lag. You earn () squares later.)",50,400)
        pop();
...
if(end===5){
    ...
    text("map on",175,230);
    text("map off",175,180);
    text("fireball",125,200);
    text("(level up)",50,180);
    text("(comet)",50,230);
